\begin{multicols*}{2}
    ...
    \begin{itemize}
        ...
        \item \textit{Only when \svg{unit_ground} or \svg{unit_flying} is attacking}: Units whose will \emph{not} reduce activated unit's \svg{health_points} to $0$ on retaliation.
