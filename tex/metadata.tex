  ...
  \raisebox{-\totalheight}[0pt][7pt]{
      \begin{tikzpicture}
        \iftoggle{noartbackground}{
          \draw (0, 0) node[inner sep=0] (header){\makebox[1.015\textwidth][c]{\includegraphics[width=1.055\linewidth, height=0.24\linewidth]{\layout/section_heading_monochrome.png}}};
        }{
...
\newcommand{\addscenariosection}[5][section]{
  ...
  \raisebox{-\totalheight}[0pt][7pt]{
    \ifthenelse{\oneliner}{\def\yscale{1}}{\def\yscale{1.3}}
      \begin{tikzpicture}
        \iftoggle{noartbackground}{
          \draw (0, 0) node[inner sep=0, yscale=\yscale] (header){\makebox[1.015\textwidth][c]{\includegraphics[width=1.055\linewidth, height=0.24\linewidth]{\layout/section_heading_monochrome.png}}};
        }{
...
\include{./dice_mod.tex}

\include{./small_mods.tex}

\include{./faction_buildings.tex}

\include{./new_costs.tex}
